  ...
  return (
    <section id="services" style={{ paddingBlock: 60 }}>
      <div className="container-x">
        <SectionHeading
          eyebrow="Everything astrology"
          title="Explore our free services"
          subtitle="From your birth chart to marriage matching — powered by authentic Vedic calculations."
        />
        <div
          style={{
            display: "grid",
        ...
        >
          {services.map((s) => (
            ...
            >
              ...
              <p style={{ color: "var(--ink-dim)", fontSize: 14, lineHeight: 1.6, margin: 0 }}>{s.desc}</p>
